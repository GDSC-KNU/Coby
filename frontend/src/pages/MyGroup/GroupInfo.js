        ...
        <header>
          <div className={styles.info1}>
            <div className={styles.groupName}>
              <p className={styles.group_exit} onClick={ExitHandleClick}>
                그룹 탈퇴하기
              </p>
              <h className={styles.group_detail_name}>{groupname}</h>
              <p className={styles.group_detail_info}>
                <img src={medal} alt="medal"></img>&nbsp;1위&nbsp;&nbsp;&nbsp;
                <img src={group} alt="member"></img>&nbsp;3/20&nbsp;&nbsp;&nbsp;
                <img src={logo} alt="logo"></img>&nbsp;{expPoint}
                &nbsp;&nbsp;&nbsp;
              </p>
            </div>
            <div className={styles.groupIntro}>
              {introEdit ? (
                <div>
                  <input
                    className={styles.introEditInput}
                    type="text"
                    value={groupdescription}
                    onChange={handleInputChange}
                    defaultValue={groupdescription}
                  ></input>
                  <button className={styles.introEditBtn} onClick={onClickIntroduce}>
                    수정
                  </button>
                </div>
              ) : (
            ...
            <div className={styles.groupNotice}>
              <p className={styles.noticeline}>
                <img src={notice} alt="img" className={styles.noticeimg}></img>
                <span className={styles.noticetitle}>
                  &nbsp;&nbsp;공지사항&nbsp;&nbsp;&nbsp;
                </span>
                코린이를 위한 멘토멘티 프로그램 운영 중입니다. 많은 참여
                부탁드립니다.
              </p>
            </div>
